...
DEFAULT_MODEL = "phi4:latest"  # Common options: "phi4:latest", "gemma3:12b", etc.
...
# Max output length for generated responses
NUM_OUTPUT_TOKENS = int(os.getenv("NUM_OUTPUT_TOKENS", 2000))
